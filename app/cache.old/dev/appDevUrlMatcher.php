...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // app_count_number
        if ($pathinfo === '/count') {
            return array (  '_controller' => 'AppBundle\\Controller\\CountController::numberAction',  '_route' => 'app_count_number',);
        }
        ...
        if (0 === strpos($pathinfo, '/t')) {
            ...
            if ($pathinfo === '/transfer') {
                return array (  '_controller' => 'AppBundle\\Controller\\TransferController::numberAction',  '_route' => 'app_transfer_number',);
            }
